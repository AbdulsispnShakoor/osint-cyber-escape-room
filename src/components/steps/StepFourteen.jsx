...
const StepFourteen = () => {
  const navigate = useNavigate()
    ...
    let questionsSixForm = [
        ...
        {
            id:3,
            quiz:"The name of the building?",
            ans:"wanda vista hotel"
        }
    ];
  ...
  return (
    ...
    <div className="form w-full">
      <form onSubmit={(e) =>  e.preventDefault()} className='w-full xl:px-36  xl:w-3/4 py-8 mx-auto '   noValidate>
        ...
        {
          questionsSixForm.length > 0 && questionsSixForm.map((question) => {
            const { quiz} = question;
            return (
              ...
              handleSubmit((data) => {
                ...
                questionsSixForm.forEach(question => {
                  ...
                  if (lower !== " ") {    
                    ...
                    }else if(lower === "wanda vista hotel"){
                        a++
                        toast.success(`${lower} : matched ✅`,{
                          duration: 2000,
                        })
                    ...
                    let q2Check = lower !== "turkey" && question.id === 2;
                    let q3Check = lower !== "wanda vista hotel" && question.id === 3;
