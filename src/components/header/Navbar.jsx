...
// import logo_01 from '../../assets/images/logo-text-gentium.png';
import logo_01 from "../../assets/images/gentium_logo_uk.png";
// import logo_02 from '../../assets/images/logo-text-wolfmind.png';
          ...
          <nav className="relative flex items-center justify-between flex-wrap gap-4 h-auto lg:h-20 transition-all ease-in duration-300">
            ...
            <div className="">
              <div className="flex-shrink-0 flex items-center gap-2">
                <a
                  href="https://www.osintescaperoom.com/"
                  target="_blank"
                  rel="noreferrer"
                  className="flex"
                >
                  <img
                    ...
                    src={logo_01}
                    alt="gentium uk cyber"
                  />
                </a>
                {/* <a href="https://www.wolfmind.nl/" target='_blank' rel="noreferrer"  className="flex">
            ...
            <div onClick={handleToggle}>
              {toggle ? (
                <button
                  type="button"
                  className="inline-flex p-2 text-white border transition-all duration-200 rounded-md"
                >
                  <svg
                ...
                <button
                  type="button"
                  className="inline-flex p-2 ml-5 border text-white transition-all duration-200 rounded-md lg:hidden"
                >
                  <svg
                    className="w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
